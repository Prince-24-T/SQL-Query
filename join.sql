...
Questions:: 1 --> Find the number of Artists in the studio (without a HAVING clause) 


Select count(role) as numberOFartict 
from employees
where role = "Artist"


Questions::2--> Find the number of Employees of each role in the studio

Select count(*) as numberOFemplyee , role 
from employees
group by role

Questions:: 3==> Find the total number of years employed by all Engineers 

Select sum(years_employed) as totalYear , role
from employees
 group by role
